package testing_all.dynamic_testing.client;
...
public class Client {
    ...
    public Client() {
        try {
            ...
            csvWriter = new PrintWriter(new FileWriter("C:/Users/mohit/OneDrive/Desktop/multithreaded/src/testing_all/client_log_dynamic.csv", false));
            ...
            while (!Thread.currentThread().isInterrupted()) {
                ...
                try {
                    ...
                    try (Socket s = new Socket("localhost", 8010);
                        ...
                        in.readLine(); // Wait for the server's "OK-..." reply
                        latency = (System.nanoTime() - startTime) / 1_000_000;
                    }
                } catch (IOException e) {
                    error = 1; // Mark as an error
                    latency = (System.nanoTime() - startTime) / 1_000_000;
                }
